...
int main()
{
    string names_file = "/home/xxy/keras-yolo3/model_data/coco_classes.txt";
    String model_def = "/home/xxy/keras-yolo3/yolov3.cfg";
    String weights = "/home/xxy/keras-yolo3/yolov3.weights";

    int in_w, in_h;
    double thresh = 0.5;
    double nms_thresh = 0.3;
    in_w = in_h = 416;

    string img_path = "/home/xxy/1.jpg";
...
//    }
    ...
    cout<<label<<endl;
    imwrite("/home/xxy/keras-yolo3/result.jpg",frame);
    imshow("res", frame);
